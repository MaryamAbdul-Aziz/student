...
layout: default
description: A test notebook entry using code for Conway's Game of Life taken from https://nighthawkcoders.github.io/APCSA/frontend/life
permalink: life
...
## Directions
Create any pattern by checking boxes to activate them. Hit `start` to run the game. The boxes will begin to move based on these rules:
